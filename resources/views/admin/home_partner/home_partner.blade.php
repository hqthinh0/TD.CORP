...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label text">thêm các hình ảnh</label>
                <div class="col-sm-10">
            ...
            <!-- end row -->
            <input type="submit" class="btn btn-info waves-effect waves-light" value="Thêm Hình Ảnh">
            </form>
