  ...
  <div class="navbar-menu-wrapper d-flex align-items-top">
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text text">Xin chào: <span class="text-black fw-bold text">{{$adminData->name}}</span></h1>
        <h3 class="welcome-sub-text text">Chúc bạn một ngày tốt lành</h3>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown d-none d-lg-block user-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          <div class="dropdown-header text-center">
           ...
           <a class="dropdown-item" href="{{ route('change.password') }}"><i class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2"></i>
            Change Password</a>
