                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{ asset('backend/assets/images/faces/face3.jpg')}}" alt="">
                                            <div>
                                              <h6>Wayne Murphy</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{ asset('backend/assets/images/faces/face4.jpg')}}" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="{{ asset('backend/assets/images/faces/face5.jpg')}}" alt="">
                                            <div>
